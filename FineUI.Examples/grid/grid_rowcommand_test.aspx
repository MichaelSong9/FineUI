<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_rowcommand_test.aspx.cs"
    Inherits="FineUI.Examples.grid.grid_rowcommand_test" %>
...
<body>
    ...
    <x:Grid ID="Grid1" Title="表格" ShowBorder="true" ShowHeader="true" AutoHeight="true"
        ...
        Height="400px" OnRowCommand="Grid1_RowCommand" EnableRowNumber="True">
        <Columns>
