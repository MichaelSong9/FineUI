...
<body>
    ...
    <x:Grid ID="Grid1" Title="表格" AllowSorting="true" SortColumn="year"
        ...
        <Columns>
            ...
            <x:BoundField Width="100px" ColumnID="year" SortField="EntranceYear" DataField="EntranceYear" HeaderText="入学年份" />
