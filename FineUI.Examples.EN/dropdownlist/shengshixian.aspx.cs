...
namespace FineUI.Examples.data
{
    public partial class shengshixian : PageBase
    {
        ...
        private void BindSheng()
        {
            ...
            ddlSheng.Items.Insert(0, new ListItem("==Select Province==", "-1"));
        }
        ...
        private void BindShi()
        {
            ...
            ddlShi.Items.Insert(0, new ListItem("==Select City==", "-1"));
        }
        ...
        private void BindXian()
        {
            ...
            ddlXian.Items.Insert(0, new ListItem("==Select County==", "-1"));
        }
        ...
        {
            labResult.Text = "Your selection: " + ddlSheng.SelectedValue + " | " + ddlShi.SelectedValue + (ddlXian.SelectedValue == "-1" ? "" : " | " + ddlXian.SelectedValue);
        }
