...
<body>
    ...
    <x:SimpleForm ID="SimpleForm1" Width="700px" runat="server" LabelWidth="120px"
        ...
        <Items>
            <x:RadioButtonList ID="RadioButtonList1" Label="List 1" runat="server">
                ...
                <x:RadioItem Text="Item 2" Value="value2" Selected="true" />
            ...
            <x:Button ID="btnCheckedItemsList1" Text="Get selected item of list 1" OnClick="btnCheckedItemsList1_Click"
                runat="server">
            </x:Button>
            <x:Label runat="server" Text="&nbsp;">
            </x:Label>
            <x:RadioButtonList ID="RadioButtonList2" Label="List 2 (Vertical)" ColumnNumber="3" ColumnVertical="true"
                runat="server">
            </x:RadioButtonList>
            <x:Button ID="btnUpdateList2" CssClass="inline" Text="Update list 2" OnClick="btnUpdateList2_Click"
                runat="server">
            </x:Button>
            <x:Button ID="btnCheckedItemsList2" Text="Get selected item of list 2" OnClick="btnCheckedItemsList2_Click"
                runat="server">
            </x:Button>
            <x:Label ID="Label1" runat="server" Text="&nbsp;">
            </x:Label>
            <x:RadioButtonList ID="RadioButtonList4" Label="List 4 (Empty list)" ColumnNumber="3" ColumnVertical="true"
                runat="server">
            </x:RadioButtonList>
            <x:Button ID="btnUpdateList4" CssClass="inline" Text="Update list 4" OnClick="btnUpdateList4_Click"
                runat="server">
            </x:Button>
            <x:Button ID="btnCheckedItemsList4" Text="Get selected item of list 4" OnClick="btnCheckedItemsList4_Click"
                runat="server">
            </x:Button>
        </Items>
    </x:SimpleForm>
    <br />
    <x:RadioButtonList ID="RadioButtonList3" Width="700px" Label="List 3" ColumnNumber="3"
        ...
        <x:RadioItem Text="Item 5" Value="value5" Selected="true" />
        <x:RadioItem Text="Item 6" Value="value6" Selected="true" />
        <x:RadioItem Text="Item 7" Value="value7" Selected="true" />
    ...
    <x:Button ID="btnCheckedItemsList3" Text="Get selected item of list 3" OnClick="btnCheckedItemsList3_Click"
        runat="server">
    </x:Button>
    </form>
</body>
