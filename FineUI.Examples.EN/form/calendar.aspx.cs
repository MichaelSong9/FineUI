    ...
    public partial class calendar : PageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Button1.Text = String.Format("Select {0}", DateTime.Now.AddDays(2).ToString(Calendar1.DateFormatString));
            }
        }
        ...
        {
            labResult1.Text = String.Format("Selected date: {0}", Calendar1.SelectedDate.Value.ToString(Calendar1.DateFormatString));
        }
