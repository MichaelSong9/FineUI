...
<body>
    ...
    <x:Panel ID="Panel2" runat="server" Height="250px" Width="750px" ShowBorder="True"
        BodyPadding="5px" Layout="Column" ShowHeader="True" Title="Panel (Height=250px Width=750px Layout=Column)">
        <Items>
    ...
    <x:Panel ID="Panel9" Height="350px" Width="750px" Layout="Column" BodyPadding="5px"
        ...
        Title="Panel（Height=350px Width=750px Layout=Column BodyPadding=5px）">
        <Items>
    ...
    <x:Panel ID="Panel10" Height="350px" Width="750px" Layout="HBox" BoxConfigAlign="Stretch"
        ...
        ShowBorder="true" ShowHeader="true" EnableBackgroundColor="true" runat="server"
        Title="Panel（Layout=HBox BoxConfigAlign=Stretch BoxConfigPosition=Start BoxConfigPadding=5 BoxConfigChildMargin=0 5 0 0）">
        <Items>
