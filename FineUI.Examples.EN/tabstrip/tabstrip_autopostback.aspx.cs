...
namespace FineUI.Examples.tabstrip
{
    public partial class tabstrip_autopostback : PageBase
    {
        ...
        protected void TabStrip1_TabIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                Label1.Text = "Tab postback time: " + DateTime.Now.ToLongTimeString();
            }
            else if (TabStrip1.ActiveTabIndex == 1)
            {
                Label2.Text = "Tab postback time: " + DateTime.Now.ToLongTimeString();
            }
            else if (TabStrip1.ActiveTabIndex == 2)
            {
                Label3.Text = "Tab postback time: " + DateTime.Now.ToLongTimeString();
            }
        }
