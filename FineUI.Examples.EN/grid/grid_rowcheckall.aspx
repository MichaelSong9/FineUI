...
<body>
    ...
    <x:Grid ID="Grid1" Title="Table" Width="800px" ShowBorder="true" ShowHeader="true"
        ...
        <Columns>
            <x:BoundField Width="100px" ExpandUnusedSpace="true" DataField="Name" DataFormatString="{0}" HeaderText="Name" />
            <x:TemplateField Width="60px" HeaderText="Gender">
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# GetGender(Eval("Gender")) %>'></asp:Label>
                </ItemTemplate>
            </x:TemplateField>
            <x:BoundField Width="100px" DataField="EntranceYear" HeaderText="Entrance Year" />
