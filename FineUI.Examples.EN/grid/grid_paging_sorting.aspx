...
<body>
    ...
    <x:Grid ID="Grid1" Title="Table" AllowSorting="true" SortColumn="name" SortDirection="ASC"
        ...
        <Columns>
            ...
            <x:BoundField Width="60px" SortField="EntranceYear" DataField="EntranceYear" HeaderText="Entrance Year" />
