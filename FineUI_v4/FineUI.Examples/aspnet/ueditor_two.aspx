...
<body>
    ...
    <x:SimpleForm ID="SimpleForm1" BodyPadding="5px"  LabelWidth="80px"
        Width="850px" Title="添加文章" runat="server">
        <Items>
            <x:TextBox ID="tbxTitle" Label="文章标题" Required="true" runat="server">
            </x:TextBox>
            <x:ContentPanel ID="ContentPanel1" runat="server" CssClass="x-form-item" 
            ...
            <x:ContentPanel ID="ContentPanel2" runat="server" CssClass="x-form-item" 
                ShowBorder="false" ShowHeader="false">
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    <tr>
                        <td valign="top" style="width: 85px;">
