<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_iframe2.aspx.cs" Inherits="FineUI.Examples.iframe.grid_iframe2" %>
        ...
        <f:Panel ID="Panel7" runat="server" BodyPadding="5px" Width="600px" Height="500px"
            ...
            <Items>
                ...
                <f:Grid ID="Grid2" Title="Grid2" PageSize="80" ShowBorder="true" BoxFlex="1" AllowPaging="true"
                    ...
                    DataKeyNames="Id,Name" OnSort="Grid2_Sort" ForceFit="true">
                    <Toolbars>
