<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="triggerbox2.aspx.cs" Inherits="FineUI.Examples.form.triggerbox2" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" runat="server" Width="550px"  EnableCollapse="true"
            ...
            <Items>
                <f:TriggerBox ID="tbxMyBox1" ShowLabel="false" TriggerIconUrl="~/res/images/16/1.png"
