<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="form2.aspx.cs" Inherits="FineUI.Examples.form.form2" %>
...
<body>
    <form id="_form1" runat="server">
        ...
        <f:Form Width="600px" BodyPadding="5px" ID="Form1" LabelWidth="100px" EnableCollapse="true"
            runat="server" Title="表单 1" MessageTarget="Under">
            <Rows>
                ...
                <f:FormRow>
                    <Items>
                        ...
                        <f:TextBox ID="TextBox2" Required="true" ShowRedStar="true" Label="电子邮箱" RegexPattern="EMAIL"
                            RegexMessage="请输入有效的邮箱地址！" Text="aaa@aa.com" runat="server">
                        </f:TextBox>
                    </Items>
                </f:FormRow>
                <f:FormRow>
                    <Items>
                        <f:DropDownList ID="DropDownList3" Label="审批人" runat="server" ForceSelection="false" Required="true" ShowRedStar="True"
                            RegexPattern="EMAIL" RegexMessage="EMAIL" >
                            <f:ListItem Text="老大甲" Value="sdsa"></f:ListItem>
                            <f:ListItem Text="老大乙" Value="cc@cc.com"></f:ListItem>
                            <f:ListItem Text="dd@dd.com" Value="2"></f:ListItem>
                        </f:DropDownList>
                    </Items>
                </f:FormRow>
                <f:FormRow>
