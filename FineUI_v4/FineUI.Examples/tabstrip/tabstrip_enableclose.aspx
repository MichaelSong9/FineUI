...
<body>
    ...
    <x:TabStrip ID="TabStrip1" Width="850px" Height="300px" EnableTabCloseMenu="true"
        ...
        <Tabs>
            ...
            <x:Tab ID="Tab2" Title="标签二" BodyPadding="5px" EnableClose="true" >
                <Items>
            ...
            <x:Tab ID="Tab4" Title="标签四" BodyPadding="5px" EnableClose="true" >
                <Items>
                    <x:Label ID="Label2" Text="标签四中的文本" runat="server" />
                </Items>
            </x:Tab>
            <x:Tab ID="Tab5" EnableClose="true" Title="标签五" BodyPadding="5px" >
                <Items>
