...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <f:Panel runat="server" ID="Panel2" Width="600px" EnableFrame="false" EnableCollapse="true" BodyPadding="5px"
            Height="200px" Title="页面/面板二（Panel->UserControlConnector->UserInfoControl）">
        </f:Panel>
        <br />
        <f:Panel runat="server" ID="Panel3" Width="600px" EnableFrame="false" EnableCollapse="true" BodyPadding="5px"
