...
<body>
    ...
    <br />
    <x:Panel ID="Panel5" Title="面板三（Width=750px）" runat="server" 
        BodyPadding="3px" ShowBorder="True" ShowHeader="True" Width="750px">
        <Items>
            <x:Form ID="Form4" ShowBorder="False" BodyPadding="5px" 
    ...
    ===========================================================================
    <br />
    <x:Panel ID="Panel9" runat="server"  Layout="VBox"
        ...
        <Items>
            <x:Form ID="Form6" ShowBorder="False" BodyPadding="5px" 
                ShowHeader="False" runat="server">
                <Rows>
                    <x:FormRow>
                        <Items>
