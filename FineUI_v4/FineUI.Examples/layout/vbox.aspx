...
<body>
    <form id="form1" runat="server">
        ...
        <x:Panel ID="Panel2" runat="server" Height="400px" Width="800px" ShowBorder="True" EnableFrame="true" EnableCollapse="true"
        ...
        <br />
        <br />
        <x:Panel ID="Panel5" runat="server" Height="400px" Width="800px" ShowBorder="True" EnableFrame="true" EnableCollapse="true"
        ...
        <br />
        <br />
        <x:Panel ID="Panel9" runat="server" Height="400px" Width="800px" ShowBorder="True" EnableFrame="true" EnableCollapse="true"
        ...
        <br />
        <br />
        <x:Panel ID="Panel13" runat="server" Height="400px" Width="800px" ShowBorder="True" EnableFrame="true" EnableCollapse="true"
        ...
        <br />
        <br />
        <x:Panel ID="Panel17" runat="server" Height="400px" Width="800px" ShowBorder="True" EnableFrame="true" EnableCollapse="true"
