...
<body>
    <form id="form1" runat="server">
        ...
        <x:Panel ID="Panel2" runat="server" Height="450px" Width="850px" ShowBorder="True" EnableFrame="true" EnableCollapse="true"
            ...
            <Items>
                <x:Panel ID="Panel1" Title="Panel1" Width="200px" Height="210px"
                ...
                <x:Panel ID="Panel3" Title="Panel2" Width="410px" Height="100px"
                ...
                <x:Panel ID="Panel5" Title="Panel4" Width="200px" Height="100px"
                    runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="true">
                    <Items>
                ...
                <x:Panel ID="Panel6" Title="Panel5" Width="200px" Height="100px"
                    runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="true">
                    <Items>
                ...
                <x:Panel ID="Panel8" Title="Panel6" Width="200px" Height="100px"
                    runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="true">
                    <Items>
