...
Ext.define('Ext.ux.SimplePagingToolbar', {
    ...
    onLoad: function () {
        ...
        this.afterTextItem.setText(Ext.String.format(this.afterPageText, d.pages));
    ...
    updateInfo: function () {
        if (this.displayItem) {
            ...
            if (this.recordCount == 0) {
                ...
                msg = Ext.String.format(this.displayMsg, this.pageIndex * this.pageSize + 1, endPoint, this.recordCount);
            }
