...
xcopy extjs_source_all\resources\ext-theme-access ..\extjs\res\ext-theme-access /Y /E
xcopy extjs_source_all\resources\ext-theme-classic ..\extjs\res\ext-theme-classic /Y /E
xcopy extjs_source_all\resources\ext-theme-gray ..\extjs\res\ext-theme-gray /Y /E
xcopy extjs_source_all\resources\ext-theme-neptune ..\extjs\res\ext-theme-neptune /Y /E
