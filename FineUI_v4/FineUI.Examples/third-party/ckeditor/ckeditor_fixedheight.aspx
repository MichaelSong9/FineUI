<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ckeditor_fixedheight.aspx.cs" ValidateRequest="false"
    Inherits="FineUI.Examples.aspnet.ckeditor_fixedheight" %>
            ...
            CKEDITOR.replace('Editor1', {
                ...
                on: {
                    instanceReady: function () {
                        ...
                        CKEDITOR.instances['Editor1'].resize('100%', containerHeight, false);
                    }
                }
            });
