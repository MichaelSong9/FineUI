...
<body>
    ...
    <x:Grid ID="Grid1" Title="表格" EnableFrame="true" EnableCollapse="true" ShowBorder="true" ShowHeader="true" Width="900px"
        ...
        <Columns>
            ...
            <x:TemplateField Width="80px" HeaderText="性别" TextAlign="Center" >
                <ItemTemplate>
            ...
            <x:BoundField Width="80px" DataField="EntranceYear" HeaderText="入学年份" TextAlign="Center" />
            <x:CheckBoxField Width="80px" RenderAsStaticField="true" DataField="AtSchool" HeaderText="是否在校" />
            <x:HyperLinkField HeaderText="所学专业" DataToolTipField="Major" DataTextField="Major" TextAlign="Center" 
