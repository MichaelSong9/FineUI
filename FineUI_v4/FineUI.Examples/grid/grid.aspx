...
<body>
    <form id="form1" runat="server">
        ...
        <x:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="表格" EnableFrame="true" EnableCollapse="true" Width="800px" runat="server" EnableFrame="true" EnableCollapse="true"
            DataKeyNames="Guid">
            <Columns>
